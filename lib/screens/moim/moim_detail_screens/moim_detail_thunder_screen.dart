 ...
 */
class MoimDetailThunderScreen extends StatefulWidget {
  final int id;

  const MoimDetailThunderScreen({required this.id, Key? key}) : super(key: key);

  @override
  State<MoimDetailThunderScreen> createState() =>
      _MoimDetailThunderScreenState();
}

class _MoimDetailThunderScreenState extends State<MoimDetailThunderScreen>
  ...
  void fetchData() async {
    ...
    try {
      ...
      print(moimData?.moimName ?? "No moimName available");
      ...
      id = data['data']['id'];
      moimThumbnailUrl = data['data']['moimThumbnailUrl'].toString();
