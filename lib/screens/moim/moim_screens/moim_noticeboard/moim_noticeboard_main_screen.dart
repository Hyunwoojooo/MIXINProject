...
import 'package:mixin_mac_2/screens/moim/moim_screens/moim_noticeboard/make_notice_screen.dart';
import 'package:mixin_mac_2/screens/moim/moim_screens/moim_noticeboard/moim_noticeboard_notice_main_screen.dart';
...
import 'moim_noticeboard_notice_detail.dart';

class MoimNoticeboardMainScreen extends StatefulWidget {
  final int moimId;

  MoimNoticeboardMainScreen(this.moimId, {super.key});

  @override
  State<MoimNoticeboardMainScreen> createState() =>
      _MoimNoticeboardMainScreenState();
}

class _MoimNoticeboardMainScreenState extends State<MoimNoticeboardMainScreen> {
  String url = '';
  int moimId = 0;
  ...
  void initState() {
    ...
    url = 'http://$ip/api/moim/boards?moimId=${widget.moimId}';
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              // PopupMenuButton(
                              //   itemBuilder: (ctx) => [
                              //     _buildPopupMenuItem('공지사항 작성'),
                              //     _buildPopupMenuItem('게시글 작성'),
                              //   ],
                              // );
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) =>
                                        MakeNoticeScreen(widget.moimId)),
                              );
                            },
                            child: Image.asset(
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                  builder: (context) =>
                                      MoimNoticeboardNoticeMainScreen(moimId)),
                            );
                          },
                        )
                      ],
