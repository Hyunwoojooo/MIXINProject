            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 12.w), // 선택 버튼 사이에 간격 추가
              ...
              Center(
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      backgroundColor:
                          isCheckCode == 1 ? MIXIN_POINT_COLOR : MIXIN_BLACK_4,
                      shape: RoundedRectangleBorder(
                  ...
                  onPressed: () async {
                    ...
                    if (isCheckCode == 1) {
                      ...
                      await storage.write(key: 'userName', value: _userNameTextEditController.text);
                      await storage.write(key: 'userGender', value: _selectedGender);
                      await storage.write(
                          key: 'userAgent', value: selectAgency);
                      await storage.write(
                          key: 'userPhoneNumber', value: _userPhoneNumberTextController.text);
  ...
  Widget buildGenderButton(String gender, bool isSelected) {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        elevation: 0.0,
        backgroundColor:
            isSelected ? MIXIN_ : WHITE, // 선택된 버튼에 파란색, 선택되지 않은 버튼에 회색 적용
        minimumSize: Size(165.w, 48.h), // 버튼 크기
        side: BorderSide(
          color: isSelected ? MIXIN_2 : MIXIN_BLACK_5,
          width: 1.5.w,
        ),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8.0), // 버튼의 둥근 모서리 설정
        ),
      ),
      child: Text(
        gender,
        style: TextStyle(
          ...
          color: isSelected
              ? MIXIN_POINT_COLOR
              : MIXIN_BLACK_4, // 선택된 버튼에 흰색 글씨, 선택되지 않은 버튼에 검은색 글씨 적용
        ),
      ),
    );
  }
